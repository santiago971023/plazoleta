...
// Filtro de Spring Security. Intercepta peticiones HTTP, extrae el token JWT, lo valida usando JwtServiceAdapter y UserDetailsService, y autentica al user en el SecurityContextHolder.
